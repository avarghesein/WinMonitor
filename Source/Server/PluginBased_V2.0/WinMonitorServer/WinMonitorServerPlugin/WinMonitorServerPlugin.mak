...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib Winmm.lib WinMonitorGenericLib.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\WinMonitorServerPlugin.pdb" /machine:I386 /def:".\EXPORTING.def" /out:"$(OUTDIR)\WinMonitorServerPlugin.dll" /implib:"$(OUTDIR)\WinMonitorServerPlugin.lib" 
DEF_FILE= \
	".\EXPORTING.def"
LINK32_OBJS= \
	"$(INTDIR)\StdAfx.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib Winmm.lib WinMonitorGenericLib.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\WinMonitorServerPlugin.pdb" /debug /machine:I386 /def:".\EXPORTING.def" /out:"$(OUTDIR)\WinMonitorServerPlugin.dll" /implib:"$(OUTDIR)\WinMonitorServerPlugin.lib" /pdbtype:sept 
DEF_FILE= \
	".\EXPORTING.def"
LINK32_OBJS= \
	"$(INTDIR)\StdAfx.obj" \
